...
class JBotResponse(object):
    def __init__(self, channel=None, resp=None, th=None, reply_as_thread=False):
        self.msg = resp
        self.channelID = channel
        self.reply_as_thread = reply_as_thread
        if self.channelID:
    ...
    def Send(self):
        if (self.msg):
            ...
            if(self.thread is not None):
                ...
                retVal = slack_client.api_call("chat.postMessage", channel=self.channelID, attachments=self.msg, as_user=True)
